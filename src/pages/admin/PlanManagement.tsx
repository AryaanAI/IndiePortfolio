...
const PlanManagement: React.FC = () => {
  ...
  const handleFeatureChange = (feature: keyof PlanFeatures, value: boolean | number) => {
    setFormData(prev => ({
      ...prev,
      features: {
        ...prev.features,
          ...
          <div key={plan.id} className="plan-card">
            ...
            <div className="plan-features">
              <div className="feature-item">
                <span className="feature-label">Published Items:</span>
                <span className="feature-value">
                  {plan.features.maxPublishedItems === -1 ? 'Unlimited' : plan.features.maxPublishedItems}
                </span>
              </div>
              <div className="feature-item">
                <span className="feature-label">Faceswap:</span>
                <span className={`feature-status ${plan.features.faceswapEnabled ? 'enabled' : 'disabled'}`}>
                  {plan.features.faceswapEnabled ? <Check size={16} /> : <X size={16} />}
                </span>
              </div>
              <div className="feature-item">
                <span className="feature-label">Todo Board:</span>
              ...
              <div className="feature-item">
                <span className="feature-label">Portfolio:</span>
                <span className={`feature-status ${plan.features.portfolioEnabled ? 'enabled' : 'disabled'}`}>
                  {plan.features.portfolioEnabled ? <Check size={16} /> : <X size={16} />}
                </span>
              </div>
              <div className="feature-item">
          ...
          <div className="plan-modal">
            ...
            <form onSubmit={handleSubmit} className="plan-form">
              ...
              <div className="features-section">
                ...
                <div className="form-group">
                  <label htmlFor="maxPublishedItems">Max Published Items</label>
                  <input
                    type="number"
                    id="maxPublishedItems"
                    value={formData.features.maxPublishedItems === -1 ? '' : formData.features.maxPublishedItems}
                    onChange={(e) => handleFeatureChange('maxPublishedItems', e.target.value === '' ? -1 : Number(e.target.value))}
                ...
                <div className="checkbox-group">
                  <label className="checkbox-label">
                    <input
                      type="checkbox"
                      checked={formData.features.faceswapEnabled}
                      onChange={(e) => handleFeatureChange('faceswapEnabled', e.target.checked)}
                    />
                    <span>Enable Faceswap</span>
                  </label>
                  ...
                  <label className="checkbox-label">
                    ...
                    />
                    <span>Enable Todo Board</span>
                  </label>

                  <label className="checkbox-label">
                    <input
                      type="checkbox"
                      checked={formData.features.portfolioEnabled}
                      onChange={(e) => handleFeatureChange('portfolioEnabled', e.target.checked)}
                    />
