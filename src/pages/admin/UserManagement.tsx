                ...
                <tr key={user.id}>
                  ...
                  <td>
                    <div className="user-stats">
                      <span className="stat-item">{stats.publishedItems} published</span>
                      <span className="stat-item">{stats.totalWorkItems} total</span>
                    </div>
                  </td>
                  <td>
                    ...
                    <div className="detail-section">
                      ...
                      <div className="stats-grid">
                        <div className="stat-card">
                          <div className="stat-number">{stats.totalWorkItems}</div>
                          <div className="stat-label">Total Work Items</div>
                        </div>
                        <div className="stat-card">
                          <div className="stat-number">{stats.publishedItems}</div>
                        ...
                        <div className="stat-card">
                          ...
                          <div className="stat-label">Completed Todos</div>
                        </div>
                      </div>
                    </div>
                  </div>
